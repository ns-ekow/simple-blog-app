"""
Django settings for ekxblog project.
...
SECRET_KEY = 'django-insecure-ak^q@20+#mfblr5h6hpod3zk+sys7&r-ibo)(^klj-8udfmt)u'
...
WSGI_APPLICATION = 'ekxblog.wsgi.application'
